        ...
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                <a href="./burgerbo.php"><img src="images/f2.png"></a>
                </div>
                <div class="detail-box">

                  <h5>
                  <a href="./burgerbo.php" id="beef">Burger Bò</a>
                  </h5>
      ...
      <div class="row">
          ...
          <div class="footer_contact">
            ...
            <div class="contact_link_box">
              <a href="">
                ...
                <span>
                  Địa Chỉ: 55 Giải Phóng
                </span>
              </a>
              <a href="">
                <i class="fa fa-phone" aria-hidden="true"></i>
                <span>
                  Số Điện Thoại: 0325 418 686
                </span>
              </a>
              <a href="">
                <i class="fa fa-envelope" aria-hidden="true"></i>
                <span>
                  eleventeam@gmail.com
                </span>
              </a>
            </div>
          </div>
        ...
        <div class="col-md-4 footer-col">
          <div class="footer_detail">
            ...
            <p>
              Lương Sơn Bá, Chúc Anh Đài ăn cơm cháy sống qua ngày. Còn bạn muốn ăn gì?
            </p>
